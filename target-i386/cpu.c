...
#define TCG_FEATURES (CPUID_FP87 | CPUID_PSE | CPUID_TSC | CPUID_MSR | \
          ...
          CPUID_FXSR | CPUID_SSE | CPUID_SSE2 | CPUID_SS | CPUID_VME)
          /* partly implemented:
...
#define TCG_EXT_FEATURES (CPUID_EXT_SSE3 | CPUID_EXT_PCLMULQDQ | \
          ...
          CPUID_EXT_MOVBE | CPUID_EXT_AES | CPUID_EXT_HYPERVISOR | CPUID_EXT_VMX) 
          /* **LAVIN** partly implemented: 
          CPUID_EXT_VMX */
          /* missing:
...
static void x86_cpu_reset(CPUState *s)
{
    ...
    env->vmread_output.vmread_field = 0x0;
    env->vmread_output.vmcs_encoding = 0x0;
