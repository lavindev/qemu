...
static inline void
gen_vmx_check_intercept_err(DisasContext *s, target_ulong pc_start, uint32_t basic_reason,
                            uint32_t error_code) {
    gen_update_cc_op(s);
    gen_jmp_im(pc_start - s->cs_base);
    gen_helper_vmx_check_intercept(cpu_env, tcg_const_i32(basic_reason),
                                   tcg_const_tl(s->pc - pc_start),
                                   tcg_const_i32(error_code));
}

static inline void
gen_vmx_check_intercept(DisasContext *s, target_ulong pc_start, uint32_t basic_reason) {
    gen_vmx_check_intercept_err(s, pc_start, basic_reason, 0);
}
...
static target_ulong disas_insn(CPUX86State *env, DisasContext *s,
    ...
    switch (b) {
        ...
        case 0x90: /* nop */
            ...
            if (prefixes & PREFIX_REPZ) {
                gen_update_cc_op(s);
                gen_jmp_im(pc_start - s->cs_base);
                gen_vmx_check_intercept(s, pc_start, VTX_EXIT_PAUSE);
        ...
        case 0xfa: /* cli */
            if (!s->vm86) {
                ...
                if (s->iopl == 3) {
                    ...
                    printf("vm86: s->iopl = %d, s->flags = %08x\n", s->iopl, (uint32_t)s->flags);
                    gen_exception(s, EXCP0D_GPF, pc_start - s->cs_base);
                }
            }
            break;
        ...
        case 0x132: /* rdmsr */
            if (s->cpl != 0) {
                ...
                gen_jmp_im(pc_start - s->cs_base);
                if (b & 2) {
                    gen_vmx_check_intercept(s, pc_start, VTX_EXIT_RDMSR);
                    gen_helper_rdmsr(cpu_env);
                } else {
                    gen_vmx_check_intercept(s, pc_start, VTX_EXIT_WRMSR);
        ...
        case 0x131: /* rdtsc */
            ...
            gen_vmx_check_intercept(s, pc_start, VTX_EXIT_RDTSC);
        ...
        case 0x133: /* rdpmc */
            gen_update_cc_op(s);
            gen_jmp_im(pc_start - s->cs_base);
            gen_vmx_check_intercept(s, pc_start, VTX_EXIT_RDPMC);
    ...
    case 0x107: /* sysret */
        ...
        case 0x1a2: /* cpuid */
            gen_update_cc_op(s);
            gen_jmp_im(pc_start - s->cs_base);
            gen_vmx_check_intercept(s, pc_start, VTX_EXIT_CPUID);
        ...
        case 0xf4: /* hlt */
            if (s->cpl != 0) {
                ...
                gen_update_cc_op(s);
                gen_jmp_im(pc_start - s->cs_base);
                gen_vmx_check_intercept(s, pc_start, VTX_EXIT_HLT);
        ...
        case 0x100:
            ...
            switch (op) {
                case 0: /* sldt */
                    ...
                    gen_vmx_check_intercept(s, pc_start, VTX_EXIT_LDTR_TR_ACCESS);
        ...
        case 0x101:
            ...
            switch (modrm) {
                ...
                case 0xc3:
                    ...
                    break;
                case 0xc4:
                    gen_helper_vtx_vmxoff(cpu_env);
                    break;
                case 0xd4:
                    gen_helper_vtx_vmfunc(cpu_env);
                    break;
                default:
                    break;
            }
            ...
            switch (op) {
                case 0: /* sgdt */
                    ...
                    gen_vmx_check_intercept(s, pc_start, VTX_EXIT_GDTR_IDTR_ACCESS);
                    gen_lea_modrm(env, s, modrm);
                    ...
                    if (mod == 3) {
                        switch (rm) {
                            case 0: /* monitor */
                                ...
                                gen_extu(s->aflag, cpu_A0);
                                gen_add_A0_ds_seg(s);
                                gen_vmx_check_intercept(s, pc_start, VTX_EXIT_MONITOR);
                            ...
                            case 1: /* mwait */
                                ...
                                gen_update_cc_op(s);
                                gen_jmp_im(pc_start - s->cs_base);
                                gen_vmx_check_intercept(s, pc_start, VTX_EXIT_MWAIT);
                ...
                case 6: /* lmsw */
                    if (s->cpl != 0) {
                        ...
                        gen_vmx_check_intercept(s, pc_start, VTX_EXIT_CR_ACCESS);
                        gen_ldst_modrm(env, s, modrm, MO_16, OR_TMP0, 0);
                    ...
                    if (mod != 3) { /* invlpg */
                        ...
                        if (s->cpl != 0) {
                            ...
                            case 1: /* rdtscp */
                                ...
                                gen_vmx_check_intercept(s, pc_start, VTX_EXIT_RDTSCP);
        ...
        case 0x109: /* wbinvd */
            if (s->cpl != 0) {
                ...
                if (!(b & 2)) {
                    gen_vmx_check_intercept(s, pc_start, VTX_EXIT_WBINVD);
                }
                /* nothing to do */
            }
            break;
        ...
        case 0x123: /* mov drN, reg */
             ...
             */
                ...
                if (b & 2) {
                    ...
                    gen_vmx_check_intercept(s, pc_start, VTX_EXIT_MOV_DR);
                    gen_op_mov_v_reg(ot, cpu_T[0], rm);
